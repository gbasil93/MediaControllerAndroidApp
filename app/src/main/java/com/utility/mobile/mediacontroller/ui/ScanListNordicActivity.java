...
public class ScanListNordicActivity extends AppCompatActivity implements ListView.OnItemClickListener{

    private final static String TAG = ScanListNordicActivity.class.getSimpleName();
        ...
        private boolean isScanResultMediaController(ScanResult scanResult){
            if(scanResult != null){
                ...
                if(device != null){
                    ...
                    return name != null && name.startsWith("BodyWorn");
                }
            }
            return false;
        }
