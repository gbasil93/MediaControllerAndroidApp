...
public class MediaControllerNordicActivity extends AppCompatActivity{
            ...
            try {
                ...
                if (intent.getAction().equals(BluetoothDevice.ACTION_ACL_CONNECTED)) {
                    ...
                    if(bondState == BluetoothDevice.BOND_BONDED){
                        ...
                        DialogHelper.getInstance().showNotificationCustomLayoutDialog(MediaControllerNordicActivity.this,
